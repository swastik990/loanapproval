  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        // login barr
        appBar: AppBar(
          title: Text('Login',  style: TextStyle(color: Color.fromARGB(255, 255, 255, 255))),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text('Don\'t have an account? Sign Up',style: TextStyle(color: Color.fromARGB(255, 33, 150, 243))),
                    ),
                    TextButton(
